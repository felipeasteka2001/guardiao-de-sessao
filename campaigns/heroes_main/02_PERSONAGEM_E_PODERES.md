...
# Ryan Krubic (Rascunho de Criação)

## Etapa 1 - Conceito (Concluída)
- Nome civil: Ryan Krubic
- Idade: 18 anos
- Altura: 1,80m
- Peso: 82kg
- Arquétipo: Manipulador Psicomaterial em Evolução
- Motivação: descobrir origem, compreender poderes, tornar-se mais poderoso.
- Poderes conceituais: manipulação de matéria, telecinese, sensibilidade telepática, alquimia material.
- Manifestação visual: energia roxa escura.
...
## Etapa 3 - Characteristics (Em andamento)
